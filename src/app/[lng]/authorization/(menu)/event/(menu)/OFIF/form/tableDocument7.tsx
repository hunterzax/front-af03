            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                <thead className="text-xs text-[#ffffff] bg-[#1473A1] sticky top-0 z-10">
                    <tr className="h-9">
                        ...
                        <th scope="col" className={`${table_sort_header_style}`} onClick={() => handleSort("doc_7_input_note_shipper", sortState, setSortState, setSortedData, mainData)}>
                            {`Remark`}
                            {getArrowIcon("doc_7_input_note_shipper")}
                        </th>
                    ...
                    {sortedData && sortedData.map((row: any, index: any) => {
                        return (
                            ...
                            >
                                ...
                                <td className="px-4 py-1 text-[#464255] ">{row?.doc_7_input_note_shipper ? row?.doc_7_input_note_shipper : ''}</td>
