...
import { PdfDoc6 } from "@/components/other/pdf_event/docEvent";
...
const FormDocument6: React.FC<FormExampleProps> = ({ mode, data, onSubmit, setIsOpenDocument, dataOpenDocument, modeOpenDocument, userDT, shipperData, emailGroupForEventData, dataNomPointForDoc6, refDocData, maiHedDocHokLasted }) => {
    ...
    const setDataChudTee = () => {
        ...
        if (groupIds1) {
            ...
            if(modeDraft){
                setSelectedShippersRender1(filteredShippers1)
                setSelectedShippers1(defaultIds1);
            }else{
                setDefaultShippersRender1(filteredShippers1); // ลบไม่ได้
                setDefaultShippersId1(defaultIds1) // ลบไม่ได้
            }
        ...
        if (groupIds2) {
            ...
            if(modeDraft){
                setSelectedShippersRender2(filteredShippers2)
                setSelectedShippers2(defaultIds2);
            }else{
                setDefaultShippersRender2(filteredShippers2); // ลบไม่ได้
                setDefaultShippersId2(defaultIds2) // ลบไม่ได้
            }
        ...
        if (groupIds3) {
            ...
            if(modeDraft){
                setSelectedShippersRender3(filteredShippers3)
                setSelectedShippers3(defaultIds3);
            }else{
                setDefaultShippersRender3(filteredShippers3); // ลบไม่ได้
                setDefaultShippersId3(defaultIds3) // ลบไม่ได้
            }
        ...
        if (groupIds4) {
            ...
            if(modeDraft){
                setSelectedShippersRender4(filteredShippers4)
                setSelectedShippers4(defaultIds4);
            }else{
                setDefaultShippersRender4(filteredShippers4); // ลบไม่ได้
                setDefaultShippersId4(defaultIds4) // ลบไม่ได้   
            }
        ...
        if (groupIds5) {
            ...
            if(modeDraft){
                setSelectedShippersRender5(filteredShippers5)
                setSelectedShippers5(defaultIds5);
            }else{
                setDefaultShippersRender5(filteredShippers5); // ลบไม่ได้
                setDefaultShippersId5(defaultIds5) // ลบไม่ได้
            }
    ...
    const handleSaveConfirm = async (data?: any) => {
        if (mode == 'create') {
            ...
            */}
            ...
            setdataPDFItem({userDT:userDT, dataOpenDocument: dataOpenDocument, data:[{item:{...data, ...payload_tso_create,}, data: data}], shipperData: shipperData, dataNomPointForDoc6: dataNomPointForDoc6})
            ...
            if (!isShipper) {
                ...
                data_post_na = {
                    ...
                    "doc_6_input_when_date": watch('doc_6_input_when_date') ? dayjs(watch('doc_6_input_when_date')).format("YYYY-MM-DD") : '',  //ช่วงเวลาของเหตุการณ์ วันที่
                    "doc_6_input_when_time": data?.doc_6_input_when_time ? dayjs(data?.doc_6_input_when_time).format('HH:mm') : '',             //ช่วงเวลาของเหตุการณ์ เวลา 
                    "doc_6_input_note": data?.doc_6_input_note,  
            ...
            setdataPDFItem({userDT:userDT, dataOpenDocument: dataOpenDocument, data:[{item:{...data, ...data_post_na,}, data: data}], shipperData: shipperData, dataNomPointForDoc6: dataNomPointForDoc6})
        ...
        >
            ...
            */}
                    ...
                    <div className="grid grid-cols-2 gap-1 pt-4">
                        <label className="w-[100px] text-[#58585A]">
                            <input
                                ...
                                value={1}
                                disabled={modeDraft ? false : ((mode == 'view' || isShipper || idChudTee1) ? true : false)}
                    ...
                    <div className="grid grid-cols-3 w-full gap-4">
                        <div className="flex flex-wrap flex-auto ">
                            ...
                            <SelectFormProps
                                ...
                                disabled={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_1') || isShipper || idChudTee1 ? true : false)} // kom test 2
                                ...
                                renderValue={(selected:any) => {
                                    ...
                                    return (
                                        <span className={`pl-[10px] text-[14px]`}>
                                            {shipper_data?.length == selectedShippers1?.length ? `Select All` : selected.map((id:any) => dataShipper1?.filter((item: any) => !defaultShippersId1?.includes(item.id)).find((item: any) => item.id === id)?.name).join(", ")}
                                        </span>
                                    );
                                }}
                            ...
                            <div className="grid grid-cols-2 w-full gap-4">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_1') || (mode === 'edit' && watch('doc_6_perm_lod_1') && idChudTee1) || isShipper ? true : false)} // kom test 3
                    ...
                    <div className="grid grid-cols-2 gap-1 pt-4">
                        <label className="w-[100px] text-[#58585A]">
                            <input
                                ...
                                value={1}
                                disabled={modeDraft ? false : ((mode == 'view' || isShipper || idChudTee2) ? true : false || watch('doc_6_perm_lod_1') ? false : true)}
                    ...
                    <div className="grid grid-cols-3 w-full gap-4">
                        <div className="flex flex-wrap flex-auto ">
                            ...
                            <SelectFormProps
                                ...
                                disabled={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_2') || isShipper || idChudTee2 ? true : false)} // kom test 2
                            ...
                            <div className="grid grid-cols-2 w-full gap-4">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_2') || (mode === 'edit' && watch('doc_6_perm_lod_2') && idChudTee2) || isShipper ? true : false)} // kom test 3
                                        ...
                                        className={`${inputClass} 
                                            ${mode === 'view' || (mode === 'edit' && !watch('doc_6_perm_lod_2')) || (mode === 'edit' && watch('doc_6_perm_lod_2') && idChudTee2 && !modeDraft) && '!bg-[#EFECEC]'}
                                        `}
                                    />
                                ...
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_2') || isShipper ? true : false)} // kom test 2
                    ...
                    <div className="grid grid-cols-2 gap-1 pt-4">
                        <label className="w-[100px] text-[#58585A]">
                            <input
                                ...
                                disabled={modeDraft ? false : ((mode == 'view' || isShipper || idChudTee3) ? true : false || watch('doc_6_perm_lod_2') ? false : true)}
                            ...
                            <div className="grid grid-cols-2 w-full gap-4">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_3') || (mode === 'edit' && watch('doc_6_perm_lod_3') && idChudTee3) || isShipper ? true : false)} // kom test 3
                                ...
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_3') || isShipper ? true : false)} // kom test 2
                    ...
                    <div className="grid grid-cols-2 gap-1 pt-4">
                        <label className="w-[100px] text-[#58585A]">
                            <input
                                ...
                                value={1}
                                disabled={modeDraft ? false : ((mode == 'view' || isShipper || idChudTee4) ? true : false || watch('doc_6_perm_lod_3') ? false : true)}
                            ...
                            <div className="grid grid-cols-2 w-full gap-4">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_4') || (mode === 'edit' && watch('doc_6_perm_lod_4') && idChudTee4) || isShipper ? true : false)} // kom test 4
                                ...
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_4') || isShipper ? true : false)} // kom test 2
                    ...
                    <div className="grid grid-cols-2 gap-1 pt-4">
                        <label className="w-[100px] text-[#58585A]">
                            <input
                                ...
                                value={1}
                                disabled={modeDraft ? false : ((mode == 'view' || isShipper || idChudTee5) ? true : false || watch('doc_6_perm_lod_4') ? false : true)}
                            ...
                            <div className="grid grid-cols-2 w-full gap-4">
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_5') || (mode === 'edit' && watch('doc_6_perm_lod_5') && idChudTee5) ? true : false)} // kom test 3
                                ...
                                <div className="">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder="รายละเอียด"
                                        readOnly={modeDraft ? false : (mode == 'view' || !watch('doc_6_perm_lod_5') ? true : false)} // kom test 2
            ...
            <div className="grid grid-cols-2 gap-4 pt-20">
                ...
                <div className="w-full col-span-2">
                    ...
                    <TextField
                        ...
                        placeholder="ระบุรายละเอียด"
                        disabled={modeDraft ? false : (mode == 'view' || mode == 'edit')}
                        rows={2}
                        sx={textFieldSx}
            ...
            {/* เลือก Email Group */}
            {
                ...
                !isShipper && // History > Detail > ส่วนของ Email Group กับ CC Mail หายไป https://app.clickup.com/t/86eum0p8x
            ...
            */}
            {
                !isShipper && (mode == 'edit' || mode == 'view') && <div className="pt-4"><TableDocument6 tableData={dataTable} dataOpenDocument={dataOpenDocument} /></div>
            }
