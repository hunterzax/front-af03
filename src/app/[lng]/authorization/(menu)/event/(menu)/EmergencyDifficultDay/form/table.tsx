...
const TableEmergencyDifficult: React.FC<TableProps> = ({
    ...
    const getDataDocumentHistoryAndVersion = async (id: String, doc_no: any) => {
        ...
        try {
            ...
            //     url += '?tso=true'
            // }
            if ((doc_no == 39 || doc_no == 41) && userDT?.account_manage?.[0]?.user_type_id == 2) {
                url += '?tso=true'
            }
                    ...
                    <table className="min-w-full text-sm text-left rtl:text-right text-gray-500 whitespace-nowrap">
                        <thead className="text-xs text-[#ffffff] sticky top-0 z-10">
                            ...
                            <tr className="h-9 bg-[#1473A1]">
                                ...
                                {userDT?.account_manage?.[0]?.user_type_id !== 3 && columnVisibility?.created_by && (
                                ...
                                >
                                    ...
                                    {columnVisibility?.info_document_39 && (
                                        ...
                                        >
                                            ...
                                            {(() => {
                                                ...
                                                const docStatus = row?.document39?.event_doc_status_id;
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <button
                                                                ...
                                                                onClick={() => handleDownloadPDFEmer('doc39', userDT?.account_manage?.[0]?.user_type_id !== 3 ? row?.document39TSOID : row?.document39?.id)}
                                                            >
                                                ...
                                                if (!hasdocument39) return null; // ถ้าไม่มี document39 ไม่โชว์ปุ่มนะ
                                                  ...
                                                  if(isShipper && row?.document39?.[0]?.event_doc_status_id === 6){
                                                    return
                                                }
                                    ...
                                    {columnVisibility?.shipper_document_39 && (
                                        ...
                                        >
                                            {(() => {
                                                ...
                                                const checkDraft = row?.document39?.find((f:any) => f?.user_type_id === 2 && f?.event_doc_status_id === 1)
                                                if(checkDraft){
                                                    return <div className="flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]" style={{ backgroundColor: checkDraft?.event_doc_status?.color }}>
                                                                {checkDraft?.event_doc_status?.name ?? ''}
                                                            </div>
                                                }else{
                                                    if (row?.document39?.length > 0) {
                                                        const count_document_2_shipper_edited = row?.document39?.filter((item: any) => [5].includes(item.event_doc_status_id)) // 3 = Accepted / 4= Rejected  / 5=Acknowledge
                                                        return `${count_document_2_shipper_edited?.length}/${row?.document39?.length - 1 || 0}`
                                                    }
                                                }
                                                    ...
                                                    row.document39.some((doc: any) => doc?.event_doc_status?.id === 6) ? (
                                                        ...
                                                        (() => {
                                                            if (row?.document39?.length > 0) {
                                                                ...
                                                                if ((count_document_2_shipper_edited?.length || 0) == (row?.document39?.length - 1 || 0)) {
                                                                    return (
                                    ...
                                    {columnVisibility?.acknowledge_document_39 && (
                                        <td
                                            ...
                                            style={renderSectionBorder('acknowledge_document_39', 'section2', 'document_39')}
                                        >
                                            {row?.document39?.event_doc_status_id == 5 && <DoneOutlinedIcon sx={{ fontSize: 20, color: '#148750' }} />}
                                        </td>
                                    )}
                                    ...
                                    {columnVisibility?.info_document_4 && (
                                        ...
                                        >
                                            ...
                                            {(() => {
                                                ...
                                                // console.log('row?.document41 : ', row?.document41?.[0]?.event_doc_status_id === 1);
                                                 if(isShipper && row?.document41?.[0]?.event_doc_status_id === 1){
                                                    return
                                                }
                                                 if(isShipper && row?.document41?.[0]?.event_doc_status_id === 6){
                                                    return
                                                }
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <button type="button" className={class_btn_} disabled={false}
                                                                ...
                                                                onClick={() => handleDownloadPDFEmer('doc41', userDT?.account_manage?.[0]?.user_type_id !== 3 ? row?.document41TSOID : row?.document41?.[0]?.id)} // new
                                                            >
                                                                <FileDownloadIcon sx={{ fontSize: 20, color: '#1473A1' }} />
                                                            </button>
                                                        </Tooltip>
                                    ...
                                    {columnVisibility?.shipper_document_4 && (
                                        ...
                                        >
                                            {(() => {
                                                 const checkDraft = row?.document41?.find((f:any) => f?.user_type_id === 2 && f?.event_doc_status_id === 1)
                                                if(checkDraft){
                                                    return <div className="flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]" style={{ backgroundColor: checkDraft?.event_doc_status?.color }}>
                                                                {checkDraft?.event_doc_status?.name ?? ''}
                                                            </div>
                                        ...
                                        >
                                            {
                                                ...
                                                Array.isArray(row?.document41) && row.document41.length > 0 ? (
                                                    ...
                                                    row.document41.some((doc: any) => doc?.event_doc_status?.id === 6) ? (
                                                        ...
                                                        (() => {
                                                            if (row?.document41?.length > 0) {
                                                                const acknow_stat = getAcknowledgeStatus(row?.document41).split("/")
                                    ...
                                    {columnVisibility?.info_document_5 && (
                                        ...
                                        >
                                            ...
                                            {(() => {
                                                ...
                                                const isTSO = !isShipper;
                                                const eventStatus = row?.event_status_id; // stat ของ main row (open, close)
                                                const docStatus = row?.document5?.event_doc_status_id;
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <button type="button" className={class_btn_} disabled={false}
                                                                ...
                                                                onClick={() => handleDownloadPDFEmer('doc5', userDT?.account_manage?.[0]?.user_type_id !== 3 ? row?.document5TSOID : row?.document5?.id)}
                                                            >
                                                                <FileDownloadIcon sx={{ fontSize: 20, color: '#1473A1' }} />
                                                            </button>
                                                        </Tooltip>
                                    ...
                                    {columnVisibility?.shipper_document_5 && (
                                        ...
                                        >
                                            {(() => {
                                                const checkDraft = row?.document5?.find((f:any) => f?.user_type_id === 2 && f?.event_doc_status_id === 1)
                                                if(checkDraft){
                                                    return <div className="flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]" style={{ backgroundColor: checkDraft?.event_doc_status?.color }}>
                                                                {checkDraft?.event_doc_status?.name ?? ''}
                                                            </div>
                                                }else{
                                                    if (row?.document5?.length > 0) {
                                                        // count จำนวนที่ shipper accept หรือ reject
                                                        const count_document_2_shipper_edited = row?.document5?.filter((item: any) => [5].includes(item.event_doc_status_id)) // 3 = Accepted / 4= Rejected  / 5=Acknowledge
                                                        return `${count_document_2_shipper_edited?.length}/${row?.document5?.length - 1 || 0}`
                                                    }
                                                }
                                                    ...
                                                    row.document5.some((doc: any) => doc?.event_doc_status?.id === 6) ? (
                                                        ...
                                                        (() => {
                                                            if (row?.document5?.length > 0) {
                                                                ...
                                                                if ((count_document_2_shipper_edited?.length || 0) == (row?.document5?.length - 1 || 0)) {
                                                                    return (
                                                                        <div className="flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]" style={{ backgroundColor: '#FDD0D0' }}>
                                                                            {`Close`}
                                                                        </div>
                                    ...
                                    {columnVisibility?.acknowledge_document_5 && (
                                        <td
                                            ...
                                            style={renderSectionBorder('acknowledge_document_5', 'section2', 'document_5')}
                                        >
                                            {row?.document5?.event_doc_status_id == 5 && <DoneOutlinedIcon sx={{ fontSize: 20, color: '#148750' }} />}
                                        </td>
                                    )}
                                    ...
                                    {columnVisibility?.info_document_6 && (
                                        ...
                                        >
                                            ...
                                            {(() => {
                                                ...
                                                const isTSO = !isShipper;
                                                const eventStatus = row?.event_status_id; // stat ของ main row (open, close)
                                                const docStatus = row?.document6?.event_doc_status_id;
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <button type="button" className={class_btn_} disabled={false}
                                                                ...
                                                                onClick={() => handleDownloadPDFEmer('doc6', userDT?.account_manage?.[0]?.user_type_id !== 3 ? row?.document6TSOID : row?.document6?.id)}
                                                            >
                                                                <FileDownloadIcon sx={{ fontSize: 20, color: '#1473A1' }} />
                                                            </button>
                                                        </Tooltip>
                                    ...
                                    {columnVisibility?.shipper_document_6 && (
                                        ...
                                        >
                                            {(() => {
                                                console.log('6 row : ', row);
                                                const checkDraft = row?.document6?.find((f:any) => f?.user_type_id === 2 && f?.event_doc_status_id === 1)
                                                console.log('checkDraft  ',  checkDraft);
                                                if(checkDraft){
                                                    return <div className="flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]" style={{ backgroundColor: checkDraft?.event_doc_status?.color }}>
                                                                {checkDraft?.event_doc_status?.name ?? ''}
                                                            </div>
                                                    ...
                                                    if (row?.document6?.length > 0) {
                                                        // count จำนวนที่ shipper accept หรือ reject
                                                        const count_document_2_shipper_edited = row?.document6?.filter((item: any) => [5].includes(item.event_doc_status_id)) // 3 = Accepted / 4= Rejected  / 5=Acknowledge
                                                        return `${count_document_2_shipper_edited?.length}/${row?.document6?.length - 1 || 0}`
                                                    }
                                                }
                                    ...
                                    {columnVisibility?.acknowledge_document_6 && (
                                        <td
                                            ...
                                            style={renderSectionBorder('acknowledge_document_6', 'section2', 'document_6')}
                                        >
                                            {row?.document6?.event_doc_status_id == 5 && <DoneOutlinedIcon sx={{ fontSize: 20, color: '#148750' }} />}
                                        </td>
                                    )}
